...
import (
	...
	"github.com/inwinstack/pan-operator/pkg/client/clientset/versioned/scheme"
...
func (c *InwinstackV1alpha1Client) NATPolicies(namespace string) NATPolicyInterface {
	return newNATPolicies(c, namespace)
}

func (c *InwinstackV1alpha1Client) SecurityPolicies(namespace string) SecurityPolicyInterface {
