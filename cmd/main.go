...
func parserFlags() {
	...
	flag.BoolVarP(&haMode, "ha", "", false, "Flag ha is an advanced option for enabling high availability.")
	flag.IntVarP(&inspectorSecond, "inspector-seconds", "", 30, "Seconds for checking the PAN status of high availability.")
